...
public interface InvocationContext<K, V>
{
    ...
    */
   AttributeResolver<K, V> getAttributeResolver(Scope attrScope) throws IllegalArgumentException;
    ...
    */
   V getAttribute(Scope attrScope, K attrKey) throws IllegalArgumentException;
    ...
    * @throws IllegalArgumentException if the attribute key or the attribute scope is not valid
    */
   void setAttribute(Scope attrScope, K attrKey, V attrValue) throws IllegalArgumentException;
    ...
    */
   void removeAttribute(Scope attrScope, K attrKey);
}
